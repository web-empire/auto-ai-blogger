...
export default function PostIdeas() {
	...
	const wpaib_create_post = ( e, title ) => {
		...
		e.target.innerHTML = `<svg class="animate-spin h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 0 1 8-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 0 1 4 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg> ${ __( 'Creating...', 'wp-ai-blogger' ) }`;
		...
		return apiFetch( {
			...
			.then( ( response ) => {
				...
				e.target.style.pointerEvents = 'auto';
				e.target.className = 'text-green-600 hover:text-green-900 inline-flex items-center gap-x-1 cursor-pointer font-semibold';
